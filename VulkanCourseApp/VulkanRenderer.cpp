...
void VulkanRenderer::cleanup()
{
	...
	{
		vkDestroyBuffer(mainDevice.logicalDevice, uniformBuffer[i], NULL);
		vkFreeMemory(mainDevice.logicalDevice, uniformBufferMemory[i], NULL);
	}
...
void VulkanRenderer::createDescriptorSetLayout()
{
	...
	mvpLayoutBinding.pImmutableSamplers = NULL;		// For Texture: Can make sampler data unchangeable (immutable) by specifying in layout
...
void VulkanRenderer::createDescriptorSets()
{
	...
	for (size_t i = 0; i < uniformBuffer.size(); i++)
	{
		...
		mvpSetWrite.dstArrayElement = 0;		// Index array to update
		...
		vkUpdateDescriptorSets(mainDevice.logicalDevice, 1, &mvpSetWrite, 0, NULL);
	}
}
