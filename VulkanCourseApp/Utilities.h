...
static std::vector<char> readFile(const std::string& filename)
{
	...
	// std::ios::ate tells streams to start reading from end of file
...
static void transitionImageLayout(VkDevice device, VkQueue queue, VkCommandPool commandPool, VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout)
{
	...
	imageMemoryBarrier.subresourceRange.levelCount = 1;		// Numver of mip levels to alter starting from baseMipLevel
	...
	// If transitioning from transfer destinaton to shader readable
